...
A full-stack stock backtesting and trading analysis platform. Run strategy backtests, analyze your real trade history, screen sectors, and track performance metrics — all in a dark fintech-style dashboard.
...
- **Portfolio vs SPY Benchmark** — Cumulative return comparison with alpha calculation
...
| Data     | Yahoo Finance (yfinance), Excel trade files  |
...
│   │   └── pages/             # Backtesting, TradingAnalysis, Screener, BotTrader
│   ├── package.json
│   └── vite.config.js
├── .gitignore
└── README.md
