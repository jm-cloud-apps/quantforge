...
export default function Journal() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Entries List */}
      {loading ? (
        <div className="text-center py-12 text-surface-400">Loading journal...</div>
      ) : filtered.length === 0 ? (
        <div className="rounded-[16px] bg-surface-900 border border-surface-700/50 border-dashed p-16 text-center">
          <p className="text-surface-300 text-[15px] font-medium">No Journal Entries Yet</p>
          <p className="text-surface-500 text-[13px] mt-1">
            Journal entries are created from the Trading Analysis page.
          </p>
        </div>
      ) : (
